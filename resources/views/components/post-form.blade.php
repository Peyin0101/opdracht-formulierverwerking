<form novalidate method="POST" action="{{ $action }}" enctype="multipart/form-data">
    ...
    <div class="mb-4">
        <div class="flex items-center gap-2">
            <input type="checkbox" value="1" name="featured" id="featured" class="border-gray-300 rounded-md">
    ...
    <div class="mb-4">
        ...
        <textarea name="introduction" id="introduction" class="w-full border-gray-300 rounded-md" required></textarea>
        @error('introduction')
        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
        @enderror
    </div>
    <div class="mb-4">
        ...
        <textarea name="content" id="content" class="w-full border-gray-300 rounded-md" required></textarea>
        @error('content')
        <p class="text-red-500 text-xs mt-1">{{ $message}}</p>
        @enderror
    </div>
